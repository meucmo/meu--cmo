...
var _vitePluginReactInlineEditor = _interopRequireDefault(await jitiImport("./plugins/visual-editor/vite-plugin-react-inline-editor.js"));
var _vitePluginEditMode = _interopRequireDefault(await jitiImport("./plugins/visual-editor/vite-plugin-edit-mode.js"));
var _vitePluginIframeRouteRestoration = _interopRequireDefault(await jitiImport("./plugins/vite-plugin-iframe-route-restoration.js"));
var _vitePluginSitePages = _interopRequireDefault(await jitiImport("./plugins/vite-plugin-site-pages.js"));
var _vitePluginPocketbaseAuth = _interopRequireDefault(await jitiImport("./plugins/vite-plugin-pocketbase-auth.js"));
var _vitePluginSessionJournal = _interopRequireDefault(await jitiImport("./plugins/session-journal/vite-plugin-session-journal.js"));

var _nodeFs = await jitiImport("node:fs");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}

const pkg = JSON.parse((0, _nodeFs.readFileSync)('./package.json', 'utf-8'));
...
(0, _vite.defineConfig)({
  ...
  customLogger: logger,
  plugins: [
  ...(isDev ? [(0, _vitePluginReactInlineEditor.default)(), (0, _vitePluginEditMode.default)(), (0, _vitePluginIframeRouteRestoration.default)(), (0, _vitePluginSitePages.default)(), (0, _vitePluginPocketbaseAuth.default)(), (0, _vitePluginSessionJournal.default)()] : []),
  ...
  server: {
    ...
    fs: {
      strict: true,
      allow: [
      _nodePath.default.resolve(__dirname),
      _nodePath.default.join(_nodePath.default.resolve(__dirname, '../..'), 'node_modules')]
